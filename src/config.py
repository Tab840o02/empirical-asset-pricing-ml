...
FEATURES_PARSIMONIOUS_PATH = PROCESSED_DIR / "features_panel_parsimonious.parquet"
PREDICTIONS_PATH = PROCESSED_DIR / "predictions.parquet"
PREDICTIONS_EXT_PATH = PROCESSED_DIR / "predictions_ext.parquet"
PREDICTIONS_PARSIMONY_PATH = PROCESSED_DIR / "predictions_parsimony.parquet"
...
RUN_MANIFEST_EXT_PATH = PROCESSED_DIR / "run_manifest_ext.json"
RUN_MANIFEST_PARSIMONY_PATH = PROCESSED_DIR / "run_manifest_parsimony.json"
EVAL_EXT_OOS_R2_PATH = PROCESSED_DIR / "eval_ext_oos_r2.csv"
EVAL_EXT_IC_PATH = PROCESSED_DIR / "eval_ext_ic_stats.csv"
EVAL_EXT_PORT_PATH = PROCESSED_DIR / "eval_ext_portfolio_perf.csv"
EVAL_TC_MONTHLY_PATH = PROCESSED_DIR / "eval_tc_monthly.csv"
EVAL_TC_SUMMARY_PATH = PROCESSED_DIR / "eval_tc_summary.csv"
EVAL_TC_EXT_MONTHLY_PATH = PROCESSED_DIR / "eval_tc_ext_monthly.csv"
EVAL_TC_EXT_SUMMARY_PATH = PROCESSED_DIR / "eval_tc_ext_summary.csv"
EVAL_PARSIMONY_OOS_R2_PATH = PROCESSED_DIR / "eval_parsimony_oos_r2.csv"
EVAL_PARSIMONY_IC_PATH = PROCESSED_DIR / "eval_parsimony_ic_stats.csv"
EVAL_PARSIMONY_PORT_PATH = PROCESSED_DIR / "eval_parsimony_portfolio_perf.csv"
