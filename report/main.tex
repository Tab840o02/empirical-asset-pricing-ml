...
Taken together, the three extensions imply a practical portfolio-design rule rather than a single-model winner: combine regime-aware model governance (Extension 1), conservative implementation assumptions (Extension 2), and parsimonious feature control (Extension 3). For real capital, this triad is more valuable than marginal in-sample metric gains because it directly addresses model fragility, execution drag, and governance constraints simultaneously.
